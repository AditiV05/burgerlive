...
function renderButtons() {
  // Loop through all buttons and update the "active" class based on the state
...
function renderIngredientsBoard() {
  ...
  for (let ingredient in state) {
    if (state[ingredient]) {
      ...
      ingredientElement.className = "items";
      ingredientElement.textContent = ingredient;
      ingredientsBoard.appendChild(ingredientElement);
    }
  }
}
